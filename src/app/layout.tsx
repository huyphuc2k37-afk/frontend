  ...
  return (
    <html lang="vi" className={`${jakarta.variable} ${quicksand.variable} ${openSans.variable} ${merriweather.variable} ${lora.variable}`} suppressHydrationWarning>
      <head>
        ...
        `}</Script>
        <link rel="preconnect" href="https://backend-production-05227.up.railway.app" crossOrigin="" />
        <link rel="dns-prefetch" href="https://backend-production-05227.up.railway.app" />

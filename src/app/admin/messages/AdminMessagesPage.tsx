            ...
            <div className="mt-4">
              ...
              {authorResults.length > 0 && (
                <div className="mt-1 max-h-40 overflow-y-auto rounded-lg border border-gray-200 bg-white">
                  {authorResults.map((a) => (
                    <button key={a.id} onClick={() => { setSelectedAuthorId(a.id); setSearchAuthor(a.name); setAuthorResults([]); }} className={`w-full px-3 py-2 text-left hover:bg-gray-50 ${selectedAuthorId === a.id ? "bg-indigo-50" : ""}`}>

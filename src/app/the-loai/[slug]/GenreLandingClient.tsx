...
import type { GenreSEO } from "@/data/genreSlugs";
...
export default function GenreLandingClient({
  ...
  // Related genres
  const otherGenres = genreSEOPages.filter((g) => g.slug !== genre.slug);
      ...
      <main className="min-h-screen">
        ...
        >
          <ol className="flex items-center gap-1">
            ...
            <li className="font-medium text-gray-800">{genre.heading}</li>
          </ol>
        </nav>
        ...
        {initialStories.length > 0 ? (
          ...
          <div className="section-container py-20 text-center">
            ...
            <p className="mt-4 text-body-lg text-gray-500">
              Chưa có truyện {genre.name.toLowerCase()} nào. Hãy quay lại sau!
            </p>
          </div>
        )}
        ...
        {/* Related genres — internal linking */}
        ...
        <section className="border-t border-gray-100 bg-gray-50/50 py-8">
          <div className="section-container">
            <h2 className="mb-3 text-heading-sm font-bold text-gray-800">
              Đọc truyện {genre.name.toLowerCase()} online miễn phí tại VStory
            </h2>
            <div className="max-w-3xl text-body-sm leading-relaxed text-gray-600">
              <p>
                ...
                {genre.name.toLowerCase()} hay nhất hoàn toàn miễn phí, với hàng
                nghìn chương được cập nhật liên tục bởi các tác giả Việt Nam.
              </p>
              <p className="mt-2">
                Kho truyện {genre.name.toLowerCase()} trên VStory bao gồm cả
